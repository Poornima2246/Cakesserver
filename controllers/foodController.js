...
const addFood = async (req, res) => {
    try {
        ...
        const mainImage = req.files.mainImage ? req.files.mainImage[0].secure_url : null;
        const addImage1 = req.files.addImage1 ? req.files.addImage1[0].secure_url : null;
        const addImage2 = req.files.addImage2 ? req.files.addImage2[0].secure_url : null;
        ...
        const cake = new CakeModel({
            ...
            price: req.body.price,
            category: req.body.category,
            mainImage, // Single main image URL
            addImage1,
            addImage2,
        });
